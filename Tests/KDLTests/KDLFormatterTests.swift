            ...
            KDLNode(
                ...
                children: [
                    ...
                    KDLNode(
                        ...
                        children: [
                            KDLNode(
                                name: "-", arguments: [.string("Alice")],
                                properties: ["email": .string("alice@example.com")]),
                            KDLNode(
                                name: "-", arguments: [.string("Bob")],
                                properties: ["email": .string("bob@example.com")])
                        ]
                    ),
                    KDLNode(
                        name: "dependencies",
                        children: [
                            KDLNode(
                                name: "kdl", arguments: [.string("^2.0.0")],
                                properties: ["optional": .boolean(false)]),
                            KDLNode(
                                name: "serde", arguments: [.string("1.0")],
                                properties: ["features": .string("derive")])
                        ]
                    )
                ]
            )
