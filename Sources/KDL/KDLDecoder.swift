...
private struct KDLKeyedDecodingContainer<K: CodingKey>: KeyedDecodingContainerProtocol {
    ...
    private func decodePrimitive<T>(_ type: T.Type, from value: KDLValue, forKey key: K) throws -> T where T: Decodable {
    ...
    private func decodeFromNode<T>(_ type: T.Type, node: KDLNode, forKey key: K) throws -> T where T: Decodable {
...
private class KDLPrimitiveDecoder: Decoder {
    ...
    func container<Key>(keyedBy type: Key.Type) throws -> KeyedDecodingContainer<Key> where Key: CodingKey {
        throw DecodingError.typeMismatch(KeyedDecodingContainer<Key>.self, DecodingError.Context(
            codingPath: codingPath,
    ...
    func unkeyedContainer() throws -> UnkeyedDecodingContainer {
        throw DecodingError.typeMismatch(UnkeyedDecodingContainer.self, DecodingError.Context(
            codingPath: codingPath,
...
private struct KDLPrimitiveSingleValueContainer: SingleValueDecodingContainer {
    ...
    func decode<T>(_ type: T.Type) throws -> T where T: Decodable {
        ...
        return try T(from: KDLPrimitiveDecoder(value: value, decoder: dummyDecoder, codingPath: codingPath))
    }
}
...
private class KDLArrayDecoder: Decoder {
    ...
    func singleValueContainer() throws -> SingleValueDecodingContainer {
        throw DecodingError.typeMismatch(SingleValueDecodingContainer.self, DecodingError.Context(
            codingPath: codingPath,
...
private struct KDLArrayUnkeyedContainer: UnkeyedDecodingContainer {
    ...
    mutating func nestedContainer<NestedKey>(keyedBy type: NestedKey.Type) throws -> KeyedDecodingContainer<NestedKey> where NestedKey: CodingKey {
        throw DecodingError.typeMismatch(KeyedDecodingContainer<NestedKey>.self, DecodingError.Context(
            codingPath: codingPath,
